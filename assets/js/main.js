...
function testAddress(){
    ...
    //Catch all fixes
    if(casebookJSON.houseNumber.length>10){
        casebookJSON.premises = casebookJSON.houseNumber + casebookJSON.premises;
        casebookJSON.houseNumber="";
    }
    if(casebookJSON.flatNumber.length>10){
        casebookJSON.premises = 'Flat '+casebookJSON.flatNumber + casebookJSON.premises;
        casebookJSON.flatNumber="";
    }
    //Shouldn't happen - but here just in case.
    if(casebookJSON.postcode.length>15){
        casebookJSON.premises = casebookJSON.premises+','+ casebookJSON.postcode ;
        casebookJSON.postcode = casebookJSON.postcode.substr(0,14);
    }
