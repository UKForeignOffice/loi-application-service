...
$(function () {
  ...
  $('#check_documents_premium').bind('click', function () {
    _paq.push([
      'trackEvent',
      '02 Choose whether to do eligibility checks',
      'Premium application - click to check documents',
    ])
  })
  ...
  $('#check_documents_dropoff').bind('click', function () {
    _paq.push([
      'trackEvent',
      '02 Choose whether to do eligibility checks',
      'Business drop-off application - click to check documents',
    ])
  })
  ...
  $('.remove_text').bind('click', function () {
    _paq.push([
      ...
      'Remove document using the link in the result list',
    ])
  })
  ...
  $('#send-options-form').bind('submit', function (e) {
    ...
    switch ($('input[name=send_postage]:checked', '#send-options-form').val()) {
      case '4':
        _paq.push(['trackEvent', '11 How you will send your documents to the legalisation office?', 'Post in UK'])
        break
      case '5':
        _paq.push(['trackEvent', '11 How you will send your documents to the legalisation office?', 'Courier in UK'])
        break
      case '6':
        _paq.push([
          'trackEvent',
          '11 How you will send your documents to the legalisation office?',
          'Overseas post or courier',
        ])
        break
    }
    this.submit()
  ...
  $('#return_address').bind('submit', function (e) {
    ...
    switch ($('input[name=return_postage]:checked', '#return_address').val()) {
      case '7':
        _paq.push(['trackEvent', '12 Choice for return post', 'Pre-paid envelope UK'])
        break
      case '8':
        _paq.push(['trackEvent', '12 Choice for return post', 'Standard Royal Mail UK'])
        break
    }
  ...
  $('#help-sae-link').bind('click', function () {
    _paq.push([
      'trackEvent',
      '17 Application confirmation page interactions',
      'Click Help with self-addressed envelopes link',
    ])
  })
