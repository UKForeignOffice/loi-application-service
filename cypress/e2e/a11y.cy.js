...
describe('Check accessiblity', () => {
  ...
  function acceptSiteCookies() {
    ...
    setCookie('cookies_policy', '{"essential":true,"settings":true,"usage":true,"campaigns":true}')
  }
  ...
  describe('Pre login pages', () => {
    ...
    it('Choose a service', () => {
      findByRole('button', { name: 'Start now' }).should('be.visible').click()
    })
  })
  ...
  describe('Post login', () => {
    ...
    it('eApp flow', () => {
      ...
      checkA11y('Get the documents legalised using the e-Apostille service')
      clickContinueBtn()
      ...
      findByTestId('app-id').then(($elem) => {
        ...
        visit(`/submit-application?id=${appId}&appReference=A-D-11-2222-3333-4444`)
      })
