...
describe('DashboardController:', () => {
  ...
  it.skip('returns a server error if no user information found', () => {
    ...
    // then
    assertWhenPromisesResolved(() => expect(resStub.serverError.callCount).to.equal(1))
  })
  ...
  describe('_addOrbitStatusesToApplications', () => {
    ...
    it('renders results even if no or error response from casebook', () => {
      ...
      expect(resStub.view.getCall(0).args[1].users_applications).to.deep.equal(expectedUserApplications)
    })
  })
