...
describe.skip('UserAddressDetailsController', () => {
  ...
  //                )
  //                    .then(function (data) {
  //                        assert.ok('Success', 'User Address Details query had no errors');
  //                        return null;
  //                    })
  //                    .catch(function (error) {
  //                        assert.notOk('Fail', 'User Address Details query had errors');
  //                        console.log(error);
  //                        return null;
  //                    });
  //
  ...
  //        )
  //            .then(function () {
  //                assert.ok('Success', 'Alternative address for test application id ' + standard_applicationID + ' Destroyed');
  //                return null;
  //            })
  //            .catch(function (error) {
  //            assert.notOk('Fail', 'Failed to destroy alternative address');
  //                return null;
  //        });
  //
  ...
  //                        assert.ok(usersaddressdetails, 'Successfully updated the Main address details');
  //                        callback();
  //                        return null;
  //                    })
  //            },
  ...
  //                        }
  //                    }).then(function (usersaddressdetails) {
  //                        assert.ok(usersaddressdetails, 'Successfully updated the Alt address details');
  //                        callback();
  //                        return null;
  //                    })
  //            }
  ...
  //                    }
  //                ).then(function () {
  //                        assert.ok('Successfully updated the main address details');
  //                        callback();
  //                        return null;
  //                    })
  //            },
  ...
  //                    }
  //                ).then(function () {
  //                        assert.ok('Successfully created an alt address');
  //                        callback();
  //                        return null;
  //                    })
  //            }
