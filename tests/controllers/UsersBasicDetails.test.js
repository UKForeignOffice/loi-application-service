...
describe.skip('UsersBasicDetailsController', () => {
  ...
  //                    assert.ok(application, 'New Test Application record created');
  ...
  //            })
  //                .then(function (application) {
  //                    assert.ok(application, 'New Test User Details record created');
  //                }).catch(function (error) {
  //                    console.log(error);
  //                    error.should.be(null);
  //                });
  ...
  //            )
  //                .then(function (application) {
  //                    assert.ok(application, 'New Test User Address Details records created');
  //                }).catch(function (error) {
  //                    console.log(error);
  //                    error.should.be(null);
  //                });
  ...
  //            })
  //                .then(function (application) {
  //                    assert.ok(application, 'New Test User Documents record created');
  //                }).catch(function (error) {
  //                    console.log(error);
  //                    error.should.be(null);
  //                });
  ...
  //            })
  //                .then(function (application) {
  //                    assert.ok(application, 'New Test User Document Count record created');
  //                }).catch(function (error) {
  //                    console.log(error);
  //                    error.should.be(null);
  //                });
  ...
  //                updatedAt: "2016-01-05"
  //            }).then(function (application) {
  //                assert.ok(application, 'New Test User Postage Details record created');
  //            }).catch(function (error) {
  //                console.log(error);
  //                error.should.be(null);
  //            })
  ...
  //            })
  //                .then(function (application) {
  //                    assert.ok(application, 'New Test Additional Application Info record created');
  //                }).catch(function (error) {
  //                    console.log(error);
  //                    error.should.be(null);
  //                });
  ...
  //            })
  //                .then(function (application) {
  //                    assert.ok(application, 'New Test Exported Data record created');
  //                }).catch(function (error) {
  //                    console.log(error);
  //                    error.should.be(null);
  //                });
  ...
  //                    .then(function(data) {
  //                        if(data==null) {
  //                            assert.ok('Successfully checked to see if a user basic details record exists of current application id, a brand new record.');
  //                        } else {
  //                            assert.ok('Successfully checked to see if a user basic details record exists of current application id, update to existing record.');
  //                        }
  //                    })
  //                    .catch( function(error) {
  //                        console.log(error);
  ...
  //                })
  //                    .then(function () {
  //                        assert.ok('Success', 'Successfully created a UserBasicDetails record for current user');
  //                    })
  //                    .catch(function (error) {
  //                        assert.notOk('Fail', 'Failed to create a UserBasicDetails record for current user');
  //                    });
  //                done();
  //
  //    });
  ...
  //                assert.notOk('Fail', 'Validation failed as promise has landed in the "then" when it should have landed in the catch denoting an error.');
  //            })
  //            .catch( function(error) {
  //                console.log('     Test Passed! - Forcing Errors for the Create User Basic Detail record test passed');
  //                assert.ok('Success', 'Successfully caused error messages to appear.');
  ...
  //                        assert.ok('Success', 'Successfully updated the UserBasicDetails record for current user');
  //                    })
  //                    .catch(function(error) {
  //                        console.log('     Test Failed! - Update User Basic Detail record test failed');
  //                        assert.notOk('Fail', 'Failed to update the UserBasicDetails record for current user');
  //                    });
  //
  //                done();
  //    });
      ...
      UsersBasicDetails.update(
        ...
        .catch((error) => {
          ...
          if (JSON.stringify(error).indexOf('Validation error') > 0) {
            ...
            assert.isOk(error, 'Successfully caused error messages to appear.')
          }
        })
