...
describe.skip('SendReturnOptionsController:', () => {
  ...
  //        })
  //            .then(function (data) {
  //                assert.ok('Success', 'Successfully found application record instance.');
  //            })
  //            .catch(function (error) {
  //                assert.notOk('Fail', 'Failed to find application record instance.');
  //            })
  //
  //        done();
  //
