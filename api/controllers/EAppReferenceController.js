...
const EAppReferenceController = {
  ...
  addReferenceToSession(req, res) {
    ...
    const illegalCharacters = HelperService.checkForIllegalCharacters(userRef)
  ...
  _checkReferenceForErrors({ req, isOverCharLimit, illegalCharacters }) {
    ...
    const charactersWithoutDuplicates = new Set(illegalCharacters.characters)
    const stringOfCharacters = Array.from(charactersWithoutDuplicates).join(', ')
