...
const EAppEligibilityQuestionsController = {
  renderEligibilityQuestion(req, res) {
    const eligibilityViews = {
      'check-documents-are-eligible': 'eApostilles/eligibilityQuestionOne.ejs',
      'check-recipient-accepts-eapostilles': 'eApostilles/eligibilityQuestionTwo.ejs',
  ...
  handleEligibilityAnswers(req, res) {
    ...
    return EAppEligibilityQuestionsController._handleYesNoAnswers(req, res, params)
  },
